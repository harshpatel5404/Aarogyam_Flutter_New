...
import 'package:aarogyamswadeshi/Screens/order/order_screen.dart';
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        InkWell(
                          ...
                          child: Obx(() => Icon(Icons.local_shipping_outlined,
                        ...
                        InkWell(
                          ...
                          child: Obx(() => Icon(Icons.person_rounded,
                              color: MainHomeController.currentIndex.value == 4
                                  ? kPrimaryColor
                                  : Colors.black,
                              size: MediaQuery.of(context).size.width * 0.08)),
                        ),
